...
{
    public class AndroidFileSystemTests : IOTests
    {
        private IPlatformFileSystem androidFileSystem;

        [OneTimeSetUp]
        public override void OneTimeSetUp()
        {
            base.OneTimeSetUp();
            androidFileSystem = new AndroidFileSystem(Application.streamingAssetsPath, Application.persistentDataPath);
        }
        ...
        public IEnumerator Exists()
        {
            ...
            Assert.IsTrue(androidFileSystem.Exists(RelativeFilePath));
            yield break;
        }
        ...
        public IEnumerator Write()
        {
            ...
            // When
            androidFileSystem.Write(RelativeFilePath, fileData);
        ...
        {
            Assert.IsTrue(androidFileSystem.Exists(RelativeFilePath));
            byte[] fileData = await androidFileSystem.Read(RelativeFilePath);

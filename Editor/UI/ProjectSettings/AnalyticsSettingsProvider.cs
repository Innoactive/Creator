...
//        {
//            GUILayout.Label("Help Us! Contribute to Improvements!", CreatorEditorStyles.Header);
//            GUILayout.Box(
//                "Innoactive Creator is actively evolving. Please, help us with your feedback. Provide us your <b>anonymous</b> usage data and contribute to improvements.",
//                CreatorEditorStyles.Paragraph);

//            GUILayout.Label("We Respect Your Privacy", CreatorEditorStyles.Header);
//            GUILayout.Box(
//                "We DO NOT collect any sensitive information such as source code, file names or your courses' structure.\n\nHere is what we collect:\n- exact version of Innoactive Creator\n- exact version of Unity\n- your system's language\n- information about usage of the Innoactive Creator's components\n\nIn order to collect the information above, we store a unique identifier within Unity's Editor Preferences. Your data is anonymized.",
//                CreatorEditorStyles.Paragraph);

//            GUILayout.Label("We Are Transparent", CreatorEditorStyles.Header);
//            GUILayout.Box(
//                "The Innoactive Creator is open-source. Feel free to check our analytics code in <b>Core/Editor/Analytics</b>\n\nIf you want to opt-out of tracking choose <i>disabled</i> from the drop-down menu.",
//                CreatorEditorStyles.Paragraph);
